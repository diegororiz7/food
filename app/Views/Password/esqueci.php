          ...
          <div class="col-lg-5 mx-auto">
            ...
            <?php endif; ?>    
              ...
              <?php echo form_open('password/processaesqueci'); ?>
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">Recuperar senha</button>
                </div>

                <div class="mt-3 d-flex justify-content-between align-items-center">                  
                  <a href="<?php echo site_url('login'); ?>" class="asuth-link text-black">Lembrei a minha senha</a>
                </div>
