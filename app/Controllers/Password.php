    ...
    public function processaReset($token = null){
        ...
        if($usuario != null){
            ...
            if($this->usuarioModel->save($usuario)){                
                ...
                //Setando as colunas 'reset_hash' e 'reset_expira_em' como null
                //Invalida o link antigo que foi enviado para o e-mail fornecido
                $usuario->completaPasswordReset();

                //Atualizamos novamente o usuário com os valores definidos acima
                $this->usuarioModel->save($usuario);
